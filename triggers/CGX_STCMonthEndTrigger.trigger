 ...
 * 
 * @description CGX_STCMonthEndTrigger
 *
 * @author <A HREF="mailto:rpayne@sitetracker.com">Ronnie Payne</A>
 *
 ***************************************************************************************************/
trigger CGX_STCMonthEndTrigger on STC_Month_End__c (before insert, before update, before delete, after insert, after update, after delete) {
    sitetracker.StTriggerFactory.createAndExecuteHandler(CGX_STCMonthEndTriggerHandler.class);
}